...
<div class="wpwh-container">
    <div class="wpwh-title-area mb-4">
        ...
        <?php if( WPWHPRO()->whitelabel->is_active() && ! empty( WPWHPRO()->whitelabel->get_setting( 'wpwhpro_whitelabel_custom_text_extensions' ) ) ) : ?>
            <p><?php echo WPWHPRO()->helpers->translate( WPWHPRO()->whitelabel->get_setting( 'wpwhpro_whitelabel_custom_text_extensions' ), 'admin-settings-license' ); ?></p>
        <?php else : ?>
            <p><?php echo sprintf( WPWHPRO()->helpers->translate( 'This page contains all approved extensions for WP Webhooks Pro. You will be able to fully manage each of the extensions right within this plugin.', 'wpwhpro-page-extensions' ), WPWHPRO()->settings->get_page_title() ); ?></p>
        <?php endif; ?>
    </div>
