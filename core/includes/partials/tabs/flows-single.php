...
<div class="wpwh-flows-wrapper">
	<div class="wpwh-container">
		<div class="wpwh-title-area mb-4">
			<h2><?php echo WPWHPRO()->helpers->translate( 'Add new Webhook', 'wpwhpro-page-flows-single' ); ?></h2>
		</div>
				...
				<div class="wpwh-flows__content-sidebar">
					<div class="wpwh-flows__content">
						...
						<div class="wpwh-form-field">
							<label for="wpwhAddNew-name" class="wpwh-form-label"><?php echo WPWHPRO()->helpers->translate( 'Enter Title Here', 'wpwhpro-page-flows-single' ); ?></label>
						...
						<div class="wpwh-flows-steps">
							...
							<div class="wpwh-flows-step" data-wpwh-flows-step-id="1">
								...
								<div class="wpwh-flows-step__inner">
									...
									<div class="wpwh-flows-step__header">
										...
										<div class="wpwh-flows-step__header-text">
											...
											<p class="wpwh-flows-step__header-text">
												<span class="wpwh-text-small"><?php echo WPWHPRO()->helpers->translate( 'Trigger', 'wpwhpro-page-flows-single' ); ?></span> <a href="#" data-toggle="modal" data-target="#chooseIntegrationTriggerModal"><?php echo WPWHPRO()->helpers->translate( 'Choose integration', 'wpwhpro-page-flows-single' ); ?></a>
											</p>
									...
									<div class="wpwh-flows-step__body">
										...
										<div class="wpwh-flows-step__fields-group">
											...
											<div class="wpwh-form-field flows-variable">
												<label for="wpwhFlowTrigger1-lorumipsum" class="wpwh-form-label">Lorum Ipsum <span class="wpwh-text-danger">*</span></label>

												<div class="flows-variable__input">
													<textarea name="" id="" value=""></textarea>
												</div>
											</div>

                      <?php /* START: WYSIWYG EDITOR */ ?>
											<div class="wpwh-form-field">
												<label for="wpwhFlowTrigger1-text" class="wpwh-form-label">Text</label>
												<textarea name="text" class="wpwh-form-input wpwh-w-100 wpwh-flows-step__wysiwyg" data-flows-init-wysiwyg id="wpwhFlowTrigger1-text" cols="30" rows="7"></textarea>
											</div>
                      <?php /* END: WYSIWYG EDITOR */ ?>

                      <?php /* START: LINKS */ ?>
											<div class="wpwh-form-field wpwh-flows-field wpwh-flows-links mt-4">
                        <h4 class="mb-2">Lorem Ipsum Text </h4>
                        <table class="wpwh-table wpwh-table--sm bg-white">
                          <thead>
                            <tr>
                              <th></th>
                              <th class="w-100 pl-0">Link</th>
                              <th>Uppercase&nbsp;title</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr class="wpwh-flows-link">
															<td class="px-0 align-middle text-center">
																<button type="button" class="wpwh-btn wpwh-btn--link p-0 wpwh-flows-link__delete">
																	<img src="<?php echo WPWHPRO_PLUGIN_URL . 'core/includes/assets/img/delete-red.svg'; ?>" alt="">
																</button>
															</td>
                              <td class="align-middle wpwh-text-left pl-0">
                                <input type="text" name="links[]" id="wpwhFlowTrigger1Link1" class="wpwh-form-input wpwh-w-100 wpwh-flows-link__link" value="https://glueoperation.tastewp.com/wp-admin/options-general.php">
                              </td>
                              <td class="align-middle wpwh-text-left">
                                <div class="d-flex align-items-center justify-content-between">
																	<div class="wpwh-toggle wpwh-toggle--on-off">
																		<input class="wpwh-toggle__input wpwh-flows-link__toggle" id="wpwhFlowTrigger1Link1Checkbox" name="links1Uppercase[]" type="checkbox" value="">
																		<label class="wpwh-toggle__btn mb-0" for="wpwhFlowTrigger1Link1Checkbox"></label>
																	</div>
																</div>
                              </td>
                            </tr>
                            ...
                            <tr class="wpwh-flows-link">
                              ...
                              <td class="align-middle wpwh-text-left pl-0">
                                <input type="text" name="links[]" id="wpwhFlowTrigger1Link1" class="wpwh-form-input wpwh-w-100 wpwh-flows-link__link" value="https://glueoperation.tastewp.com/wp-admin/options-general.php" placeholder="enter your link here">
                              </td>
                              <td class="align-middle wpwh-text-left">
                                <div class="d-flex align-items-center justify-content-between">
																	<div class="wpwh-toggle wpwh-toggle--on-off">
                        ...
                        <div class="text-right mt-3">
                          <button type="button" class="wpwh-btn wpwh-btn--secondary wpwh-btn--sm wpwh-flows-links__add">
                            <span><?php echo WPWHPRO()->helpers->translate( 'Add link', 'wpwhpro-page-flows-single' ); ?></span>
                          </button>
                        </div>
											</div>
                      <?php /* END: LINKS */ ?>
						...
						<button type="button" class="wpwh-btn wpwh-btn--secondary wpwh-btn--lg wpwh-btn--block wpwh-flows-select-trigger mt-5" data-toggle="modal" data-target="#chooseIntegrationTriggerModal">
							<span><?php echo WPWHPRO()->helpers->translate( 'Select a trigger', 'wpwhpro-page-flows-single' ); ?></span>
						</button>
						...
						<button class="wpwh-btn wpwh-btn--secondary wpwh-btn--lg wpwh-btn--block wpwh-flows-select-trigger" disabled><span><?php echo WPWHPRO()->helpers->translate( 'Add an action', 'wpwhpro-page-flows-single' ); ?></span></button>
						...
						<div class="wpwh-flows-widget">
							<div class="wpwh-publish-box">
								...
								<p class="d-flex align-items-center">
									...
									<span class="wpwh-publish-box__title"><?php echo WPWHPRO()->helpers->translate( 'Status:', 'wpwhpro-page-flows-single' ); ?></span>
									<select name="status" id="wpwhFlowsAddNew-status" class="wpwh-form-input wpwh-form-input--sm w-auto">
										<option value="inactive"><?php echo WPWHPRO()->helpers->translate( 'Inactive', 'wpwhpro-page-flows-single' ); ?></option>
										<option value="active"><?php echo WPWHPRO()->helpers->translate( 'Active', 'wpwhpro-page-flows-single' ); ?></option>
									</select>
								</p>
								...
								<p class="d-flex align-items-center">
									...
									<span class="wpwh-publish-box__title"><?php echo WPWHPRO()->helpers->translate( 'Created on:', 'wpwhpro-page-flows-single' ); ?></span>
									<strong><?php echo date( WPWHPRO()->helpers->translate( 'F j, Y', 'wpwhpro-page-flows-single' ), strtotime( 'July 14, 2021' ) ); ?></strong>
								</p>

								<button type="submit" class="wpwh-btn wpwh-btn--secondary wpwh-btn--sm"><span>Save<?php echo WPWHPRO()->helpers->translate( '', 'wpwhpro-page-flows-single' ); ?></span></button>

							</div>
						</div>

						<div class="wpwh-flows-widget">
							<h4 class="wpwh-flows-widget__title"><?php echo WPWHPRO()->helpers->translate( 'Selected Steps:', 'wpwhpro-page-flows-single' ); ?></h4>
							<div class="wpwh-selected-steps">

								<p class="m-0"><?php echo WPWHPRO()->helpers->translate( 'No selected steps', 'wpwhpro-page-flows-single' ); ?></p>
...
<!-- INTEGRATION TRIGGER MODAL - START -->
<div class="modal fade wpwh-flows-modal" id="chooseIntegrationTriggerModal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title"><?php echo WPWHPRO()->helpers->translate( 'Choose Integration', 'wpwhpro-page-flows-single' ); ?></h3>
      ...
      <div class="modal-body" id="wpwh-authentication-content-wrapper">
				<div class="wpwh-flows-integrations">
					...
					$integration_triggers = WPWHPRO()->integrations->get_triggers( $integration_slug );

					//Skip if no triggers are given
					if( empty( $integration_triggers ) ){
						continue;
					}
						...
						<a href="#" class="wpwh-flows-integration">
							<div class="wpwh-flows-integration__inner">
								<div class="wpwh-flows-integration__icon">
									<img src="<?php echo $integration_image; ?>" alt="<?php echo sprintf( WPWHPRO()->helpers->translate( 'The logo of the %1$s integration.', 'wpwhpro-page-flows-single' ), $integration_name ); ?>">
								</div>
								<p class="wpwh-flows-integration__text"><?php echo $integration_name; ?></p>
							</div>
						</a>
					<?php endforeach; ?>
					<?php endif; ?>
...
<!-- INTEGRATION TRIGGER MODAL - END -->

<!-- INTEGRATION ACTION MODAL - START -->
<div class="modal fade wpwh-flows-modal" id="chooseIntegrationActionModal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title"><?php echo WPWHPRO()->helpers->translate( 'Choose Integration', 'wpwhpro-page-flows-single' ); ?></h3>
      ...
      <div class="modal-body" id="wpwh-authentication-content-wrapper">
				<div class="wpwh-flows-integrations">
					...
					$integration_image = isset( $integration_details['icon'] ) ? $integration_details['icon'] : WPWHPRO_PLUGIN_URL . 'core/includes/assets/img/wp-icon.svg';
					$integration_name = isset( $integration_details['name'] ) ? $integration_details['name'] : WPWHPRO()->helpers->translate( 'Undefined', 'wpwhpro-page-flows-single' );
					$integration_actions = WPWHPRO()->integrations->get_actions( $integration_slug );

					//Skip if no actions are given
...
<!-- INTEGRATION ACTION MODAL - END -->

<script>
jQuery(document).ready(function($) {
  // $('[data-target="#chooseIntegrationTriggerModal"]').trigger('click');
});
</script>