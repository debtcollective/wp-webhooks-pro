    ...
    $options_type = array(
      ...
      'options',
		...
		if( empty( $object_id ) && ! in_array( $type, $options_type ) ){
			$return['msg'] = WPWHPRO()->helpers->translate( 'No object id was given.', 'manage-acf-meta' );
			return $return;
		}

		if( empty( $meta_acf ) ){
			$return['msg'] = WPWHPRO()->helpers->translate( 'The meta_acf argument cannot be empty.', 'manage-acf-meta' );
			return $return;
		}
		...
		if( empty( $meta_acf ) || ! is_array( $meta_acf ) ){
			$return['msg'] = WPWHPRO()->helpers->translate( 'There was an issue decoding the meta_acf JSON.', 'manage-acf-meta' );
			return $return;
        }
		...
		$return['success'] = true;
		$return['msg'] = WPWHPRO()->helpers->translate( 'The given ACF data has been successfully executed.', 'manage-acf-meta' );
...
<p class="text-secondary">
  <strong><?php echo WPWHPRO()->helpers->translate( "Important:", $identifier ); ?></strong> <?php echo WPWHPRO()->helpers->translate( "We created a meta value generator that helps you to get started using this argument. You will find the generator here within the ACF section:", $identifier ); ?> <a target="_blank" title="<?php echo WPWHPRO()->helpers->translate( "Advanced Custom Fields Meta value generator", $identifier ); ?>" href="https://wp-webhooks.com/blog/how-to-update-custom-post-meta-values-with-wp-webhooks/">https://wp-webhooks.com/blog/how-to-update-custom-post-meta-values-with-wp-webhooks/</a>.
</p>
<br>
<br>
