  ...
  */
  class WP_Webhooks_Integrations_givewp_Triggers_give_donation_abandoned {
	...
	public function get_details(){
		...
		$translation_ident = "action-give_donation_abandoned-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			'webhook_name' => 'Donation abandoned',
			'webhook_slug' => 'give_donation_abandoned',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'give_update_payment_status',
		...
		return array(
			...
			'name'			  => WPWHPRO()->helpers->translate( 'Donation abandoned', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a donation was abandoned', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a donation was abandoned within GiveWP.', $translation_ident ),
