...
if ( ! class_exists( 'WP_Webhooks_Integrations_woocommerce_Triggers_wc_coupon_created' ) ) :

 /**
  * Load the wc_coupon_created trigger
  *
  * @since 4.3.2
  * @author Ironikus <info@ironikus.com>
  */
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_coupon_created {
	...
	public function get_callbacks(){
		...
		return array(
			array(
				...
				'callback' => array( $this, 'wc_coupon_created_callback' ),
				'priority' => 20,
				'arguments' => 1,
				'delayed' => true,
			),
	...
	public function get_details(){
		...
		$translation_ident = "trigger-wc_coupon_created-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			'webhook_name' => 'Coupon created',
			'webhook_slug' => 'wc_coupon_created',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'woocommerce_new_coupon',
		...
		return array(
			'trigger'		   => 'wc_coupon_created',
			'name'			  => WPWHPRO()->helpers->translate( 'Coupon created', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a coupon was created', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a coupon was created within Woocommerce.', $translation_ident ),
	 ...
	 * @param mixed $arg
	 */
	public function wc_coupon_created_callback( $arg ){

		$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'wc_coupon_created' );
		$payload = array();
		$payload_track = array();
		...
		do_action( 'wpwhpro/webhooks/trigger_wc_coupon_created', $payload, $response_data_array, $payload_track );
	}
	...
	public function get_demo( $options = array() ) {
		...
		$data = array (
			...
			'date_created_gmt' => '2021-12-27T19:47:26',
			'date_modified' => '2021-12-27T19:47:26',
			'date_modified_gmt' => '2021-12-27T19:47:26',
			'discount_type' => 'percent',
			'description' => 'This is a demo coupon',
			'date_expires' => '2021-12-31T00:00:00',
			'date_expires_gmt' => '2021-12-31T00:00:00',
			'usage_count' => 0,
			'individual_use' => true,
			'product_ids' => 
			array (
			...
			array (
			  ...
			  array (
				0 => 
				array (
				  'href' => 'https://yourdomain.test/wp-json/wc/v2/coupons/8090',
				),
			  ),
			  'collection' => 
			  array (
