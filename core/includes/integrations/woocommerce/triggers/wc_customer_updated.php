  ...
  */
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_customer_updated {
	...
	public function get_details(){
		...
		$translation_ident = "trigger-wc_customer_updated-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			...
			'webhook_slug' => 'wc_customer_updated',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'profile_update',
		...
		return array(
			...
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a customer was updated within Woocommerce.', $translation_ident ),
