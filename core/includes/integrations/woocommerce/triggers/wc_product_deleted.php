...
if ( ! class_exists( 'WP_Webhooks_Integrations_woocommerce_Triggers_wc_product_deleted' ) ) :

 /**
  * Load the wc_product_deleted trigger
  *
  * @since 4.3.2
  * @author Ironikus <info@ironikus.com>
  */
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_product_deleted {
	...
	public function get_callbacks(){
		...
		return array(
			array(
				'type' => 'action',
				'hook' => 'wp_trash_post',
				'callback' => array( $this, 'wc_product_deleted_callback' ),
				'priority' => 20,
				'arguments' => 1,
				'delayed' => false,
			),
	...
	public function get_details(){
		...
		$translation_ident = "trigger-wc_product_deleted-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			'webhook_name' => 'Product deleted',
			'webhook_slug' => 'wc_product_deleted',
			'post_delay' => false,
			'trigger_hooks' => array(
				array( 
					'hook' => 'wp_trash_post',
		...
		return array(
			'trigger'		   => 'wc_product_deleted',
			'name'			  => WPWHPRO()->helpers->translate( 'Product deleted', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a product was deleted', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a product was deleted within Woocommerce.', $translation_ident ),
	...
	/**
	 * Triggers once a product was deleted
	 *
	 * @param mixed $arg
	 */
	public function wc_product_deleted_callback( $arg ){

		$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'wc_product_deleted' );
		$payload = array();
		$payload_track = array();
		...
		do_action( 'wpwhpro/webhooks/trigger_wc_product_deleted', $payload, $response_data_array, $payload_track );
	}
