  ...
  */
  class WP_Webhooks_Integrations_woocommerce_Triggers_wc_product_created {
	...
	public function get_details(){
		...
		$translation_ident = "trigger-wc_product_created-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			'webhook_name' => 'Product created',
			'webhook_slug' => 'wc_product_created',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'woocommerce_new_product',
		...
		return array(
			...
			'name'			  => WPWHPRO()->helpers->translate( 'Product created', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a product was created', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a product was created within Woocommerce.', $translation_ident ),
