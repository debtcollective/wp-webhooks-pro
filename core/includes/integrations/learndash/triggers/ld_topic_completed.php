  ...
  */
  class WP_Webhooks_Integrations_learndash_Triggers_ld_topic_completed {
	...
	public function get_details(){
		...
		$translation_ident = "action-ld_topic_completed-description";
		...
		$parameter = array(
			...
			'course_id' => array( 'short_description' => WPWHPRO()->helpers->translate( '(Integer) The ID of the related course.', $translation_ident ) ),
			'lesson_id' => array( 'short_description' => WPWHPRO()->helpers->translate( '(Integer) The ID of the related lesson.', $translation_ident ) ),
			'topic_id' => array( 'short_description' => WPWHPRO()->helpers->translate( '(Integer) The ID of the related topic.', $translation_ident ) ),
			...
			'lesson' => array( 'short_description' => WPWHPRO()->helpers->translate( '(Array) All details of the lesson.', $translation_ident ) ),
			'topic' => array( 'short_description' => WPWHPRO()->helpers->translate( '(Array) All details of the topic.', $translation_ident ) ),
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			'webhook_name' => 'Topic completed',
			'webhook_slug' => 'ld_topic_completed',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'learndash_topic_completed',
					'url' => 'https://developers.learndash.com/hook/learndash_topic_completed/',
				),
			),
			'tipps' => array(
		...
		return array(
			...
			'name'			  => WPWHPRO()->helpers->translate( 'Topic completed', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a topic was completed', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a topic was completed within LearnDash.', $translation_ident ),
