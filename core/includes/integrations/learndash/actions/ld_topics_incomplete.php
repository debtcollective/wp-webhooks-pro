	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			if( empty( $user_id ) || empty( $course_id ) ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "Please set the user_id and course_id arguments.", 'action-ld_topics_incomplete-error' );
				return $return_args;
			}
			...
			if( $topics_incompleted ){
				...
				$return_args['msg'] = WPWHPRO()->helpers->translate( "The topics have been successfully marked as incomplete.", 'action-ld_topics_incomplete-success' );
				...
				$return_args['msg'] = WPWHPRO()->helpers->translate( "The topics could not be fully marked as incomplete.", 'action-ld_topics_incomplete-success' );
				$return_args['data']['user_id'] = $user_id;
				$return_args['data']['topic_ids'] = $validated_topic_ids;
				$return_args['data']['topics_incompleted'] = $topics_incompleted;
			}
