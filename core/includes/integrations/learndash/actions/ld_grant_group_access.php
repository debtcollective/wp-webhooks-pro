	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			if( empty( $user_id ) || empty( $group_id ) ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "Please set the user_id and group_id arguments.", 'action-ld_grant_group_access-error' );
				return $return_args;
			}

			if( ! is_numeric( $group_id ) ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "Please set only a group ID for the group_id argument.", 'action-ld_grant_group_access-error' );
				return $return_args;
			}
			...
			if( $access_granted ){
				...
				$return_args['msg'] = WPWHPRO()->helpers->translate( "The group access has been successfully granted.", 'action-ld_grant_group_access-success' );
				$return_args['data']['user_id'] = $user_id;
				$return_args['data']['group_id'] = $group_id;
				$return_args['data']['access_granted'] = $access_granted;
			} else {
				$return_args['msg'] = WPWHPRO()->helpers->translate( "There was an issue while granting the group access within Learndash.", 'action-ld_grant_group_access-success' );
				$return_args['data']['user_id'] = $user_id;
				$return_args['data']['group_id'] = $group_id;
				$return_args['data']['access_granted'] = $access_granted;
			}
