	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			if( empty( $user_id ) || empty( $course_ids ) ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "Please set both the user_id and course_ids arguments.", 'action-ld_grant_course_access-error' );
				return $return_args;
			}
			...
			foreach( $validated_course_ids as $scid ){
				...
				$return_args['msg'] = WPWHPRO()->helpers->translate( "The course access has been successfully granted.", 'action-ld_grant_course_access-success' );
