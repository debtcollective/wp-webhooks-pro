        ...
        public function get_shortcode_tags(){
            $tags = array(
                ...
                'post_permalink' => array(
                    ...
                    'title' => WPWHPRO()->helpers->translate( 'Post Permalink', 'trigger-wpwh_button' ),
                    'description' => WPWHPRO()->helpers->translate( 'The permalink of the currently given post.', 'trigger-wpwh_button' ),
