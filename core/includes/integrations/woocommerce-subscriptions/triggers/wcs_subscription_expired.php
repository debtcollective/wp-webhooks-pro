...
if ( ! class_exists( 'WP_Webhooks_Integrations_woocommerce_subscriptions_Triggers_wcs_subscription_expired' ) ) :

 /**
  * Load the wcs_subscription_expired trigger
  *
  * @since 5.2
  * @author Ironikus <info@ironikus.com>
  */
  class WP_Webhooks_Integrations_woocommerce_subscriptions_Triggers_wcs_subscription_expired {
	...
	public function get_callbacks(){
		...
		return array(
			array(
				...
				'callback' => array( $this, 'wcs_subscription_expired_callback' ),
				'priority' => 20,
				'arguments' => 1,
				'delayed' => true,
			),
	...
	public function get_details(){
		...
		$translation_ident = "trigger-wcs_subscription_expired-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			...
			'webhook_slug' => 'wcs_subscription_expired',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'woocommerce_subscription_status_expired',
		...
		return array(
			'trigger'		   => 'wcs_subscription_expired',
			'name'			  => WPWHPRO()->helpers->translate( 'Subscription expired', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a subscription expired', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a subscription expired within WooCommerce Subscriptions.', $translation_ident ),
	...
	public function wcs_subscription_expired_callback( $subscription ){	

		$subscription_id = $subscription->get_id();
		$user_id = $subscription->get_user_id();
		$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'wcs_subscription_expired' );
		...
		do_action( 'wpwhpro/webhooks/trigger_wcs_subscription_expired', $payload, $response_data_array );
	}
