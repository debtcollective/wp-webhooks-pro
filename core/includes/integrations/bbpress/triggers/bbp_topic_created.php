  ...
  */
  class WP_Webhooks_Integrations_bbpress_Triggers_bbp_topic_created {
	...
	public function get_details(){
		...
		$translation_ident = "action-bbp_topic_created-description";
		...
		$parameter = array(
			...
			'topic_author' => array( 'short_description' => WPWHPRO()->helpers->translate( '(Integer) The ID of the author of the topic.', $translation_ident ) ),
			'topic_data' => array( 'short_description' => WPWHPRO()->helpers->translate( '(Array) Further data about the given topic.', $translation_ident ) ),
		);

		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			'webhook_name' => 'Topic created',
			'webhook_slug' => 'bbp_topic_created',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'bbp_new_topic',
		...
		return array(
			...
			'name'			  => WPWHPRO()->helpers->translate( 'Topic created', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a topic was created', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a topic was created within bbPress.', $translation_ident ),
