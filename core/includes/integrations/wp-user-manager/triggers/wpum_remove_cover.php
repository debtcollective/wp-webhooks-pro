  ...
  */
  class WP_Webhooks_Integrations_wp_user_manager_Triggers_wpum_remove_cover {
	...
	public function get_details(){
		...
		$translation_ident = "action-wpum_remove_cover-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			...
			'webhook_slug' => 'wpum_remove_cover',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'wpum_user_update_remove_cover',
		...
		return array(
			...
			'name'			  => WPWHPRO()->helpers->translate( 'Cover photo removed', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a cover photo was removed', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a cover photo was removed within WP User Manager.', $translation_ident ),
