  ...
  */
  class WP_Webhooks_Integrations_wp_user_manager_Triggers_wpum_update_avatar {
	...
	public function get_details(){
		...
		$translation_ident = "action-wpum_update_avatar-description";

		$parameter = array(
			'avatar_url' => array( 'short_description' => WPWHPRO()->helpers->translate( '(String) The URL of the uploaded profile image.', $translation_ident ) ),
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			'webhook_name' => 'Profile photo updated',
			'webhook_slug' => 'wpum_update_avatar',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'wpum_user_update_change_avatar',
		...
		return array(
			...
			'name'			  => WPWHPRO()->helpers->translate( 'Profile photo updated', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a profile photo was updated', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a profile photo was updated within WP User Manager.', $translation_ident ),
