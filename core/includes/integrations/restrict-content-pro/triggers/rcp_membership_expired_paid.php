...
if ( ! class_exists( 'WP_Webhooks_Integrations_restrict_content_pro_Triggers_rcp_membership_expired_paid' ) ) :

 /**
  * Load the rcp_membership_expired_paid trigger
  *
  * @since 4.3.6
  * @author Ironikus <info@ironikus.com>
  */
  class WP_Webhooks_Integrations_restrict_content_pro_Triggers_rcp_membership_expired_paid {
	...
	public function get_callbacks(){
		...
		return array(
			array(
				...
				'callback' => array( $this, 'rcp_membership_expired_paid_callback' ),
				'priority' => 20,
				'arguments' => 2,
				'delayed' => true,
			),
	...
	public function get_details(){
		...
		$translation_ident = "action-rcp_membership_expired_paid-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			...
			'webhook_slug' => 'rcp_membership_expired_paid',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'rcp_transition_membership_status_expired',
		...
		return array(
			'trigger'		   => 'rcp_membership_expired_paid',
			'name'			  => WPWHPRO()->helpers->translate( 'Paid membership expired', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a paid membership expired', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a paid membership expired within Restrict Content Pro.', $translation_ident ),
	...
	public function rcp_membership_expired_paid_callback( $old_status, $membership_id ){
		...
		$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'rcp_membership_expired_paid' );
		...
		do_action( 'wpwhpro/webhooks/trigger_rcp_membership_expired_paid', $payload, $response_data_array );
	}
	...
	public function get_demo( $options = array() ) {
		...
		$data = array (
			...
			array (
			  ...
			  'notes' => 'February 21, 2022 11:00:41 - Membership activated.
		  
		  February 21, 2022 11:00:43 - Membership manually created by admin.
		  
		  February 21, 2022 11:40:23 - Status changed from active to expired.
		  
		  February 21, 2022 11:40:23 - Expiration Date changed from  to 2022-02-20 11:40:23.',
