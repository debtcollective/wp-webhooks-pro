...
if ( ! class_exists( 'WP_Webhooks_Integrations_restrict_content_pro_Triggers_rcp_membership_expired_free' ) ) :

 /**
  * Load the rcp_membership_expired_free trigger
  *
  * @since 4.3.6
  * @author Ironikus <info@ironikus.com>
  */
  class WP_Webhooks_Integrations_restrict_content_pro_Triggers_rcp_membership_expired_free {
	...
	public function get_callbacks(){
		...
		return array(
			array(
				...
				'callback' => array( $this, 'rcp_membership_expired_free_callback' ),
				'priority' => 20,
				'arguments' => 2,
				'delayed' => true,
			),
	...
	public function get_details(){
		...
		$translation_ident = "action-rcp_membership_expired_free-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			...
			'webhook_slug' => 'rcp_membership_expired_free',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'rcp_transition_membership_status_expired',
		...
		return array(
			'trigger'		   => 'rcp_membership_expired_free',
			'name'			  => WPWHPRO()->helpers->translate( 'Free membership expired', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a free membership expired', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a free membership expired within Restrict Content Pro.', $translation_ident ),
	...
	public function rcp_membership_expired_free_callback( $old_status, $membership_id ){
		...
		$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'rcp_membership_expired_free' );
		...
		do_action( 'wpwhpro/webhooks/trigger_rcp_membership_expired_free', $payload, $response_data_array );
	}
	...
	public function get_demo( $options = array() ) {
		...
		$data = array (
		  ...
		  February 21, 2022 11:39:31 - Status changed from active to expired.
		  
		  February 21, 2022 11:39:31 - Expiration Date changed from  to 2022-02-20 11:39:31.
		  
		  February 21, 2022 11:49:35 - Status changed from expired to active.
		  
		  February 21, 2022 11:49:35 - Expiration Date changed from 2022-02-20 11:39:31 to 2022-02-20 23:59:59.
		  
		  February 21, 2022 11:49:35 - Membership edited by admin.',
