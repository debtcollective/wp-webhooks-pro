  ...
  */
  class WP_Webhooks_Integrations_restrict_content_pro_Triggers_rcp_membership_cancelled_paid {
	...
	public function get_details(){
		...
		$translation_ident = "action-rcp_membership_cancelled_paid-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			...
			'webhook_slug' => 'rcp_membership_cancelled_paid',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'rcp_transition_membership_status_expired',
		...
		return array(
			...
			'name'			  => WPWHPRO()->helpers->translate( 'Paid membership cancelled', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a paid membership was cancelled', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a paid membership was cancelled within Restrict Content Pro.', $translation_ident ),
