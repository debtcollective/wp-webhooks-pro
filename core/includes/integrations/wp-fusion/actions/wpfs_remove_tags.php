...
<ol>
	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			if( empty( $user ) ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "Please set the user argument to either the user id or user email.", 'action-wpfs_remove_tags-error' );
				return $return_args;
			}

			if( empty( $tags ) ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "Please set the tags argument.", 'action-wpfs_remove_tags-error' );
				return $return_args;
			}
            ...
            if( empty( $user_id ) ){
                $return_args['msg'] = WPWHPRO()->helpers->translate( "We could not find a user for your given user id.", 'action-wpfs_remove_tags-error' );
				return $return_args;
            }
			...
			$return_args['msg'] = WPWHPRO()->helpers->translate( "Tags have been removed from the given user.", 'action-wpfs_remove_tags-success' );
