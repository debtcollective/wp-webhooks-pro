...
<ol>
	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			$translation_ident = "action-pmpro_membership_get-execute";
			$return_args = array(
				'success' => false,
				'msg' => '',
				'membership' => array(),
			...
			if( empty( $user_level ) ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "The given user does not have any memberships.", $translation_ident );
			} else {
				$return_args['msg'] = WPWHPRO()->helpers->translate( "The membership has been returned successfully.", $translation_ident );
