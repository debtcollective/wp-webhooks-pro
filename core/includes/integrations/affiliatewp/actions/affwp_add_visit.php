...
<ol>
	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			$return_args = array(
				'success' => false,
				'msg' => WPWHPRO()->helpers->translate( "No visit was created.", 'action-affwp_add_visit-error' ),
				'data' => array(),
			);
			...
			if( empty( $affiliate_id ) ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "We could not find an affiliate for your given data.", 'action-affwp_add_visit-error' );
				return $return_args;
			}
			...
			if( ! empty( $visit_id ) ){
				...
				$return_args['msg'] = WPWHPRO()->helpers->translate( "The visit was successfully created.", 'action-affwp_add_visit-error' );
			} else {
				$return_args['msg'] = WPWHPRO()->helpers->translate( "An error occured while creating your visit.", 'action-affwp_add_visit-success' );
			}
