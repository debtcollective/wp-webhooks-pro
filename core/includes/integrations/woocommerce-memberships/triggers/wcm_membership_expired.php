  ...
  */
  class WP_Webhooks_Integrations_woocommerce_memberships_Triggers_wcm_membership_expired {
	...
	public function get_details(){
		...
		$translation_ident = "trigger-wcm_membership_expired-description";

		$parameter = array(
			'user_id' => array( 'short_description' => WPWHPRO()->helpers->translate( '(Integer) The ID of the user the membership was expired for.', $translation_ident ) ),
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			...
			'webhook_slug' => 'wcm_membership_expired',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'wc_memberships_user_membership_status_changed',
		...
		return array(
			...
			'sentence'			  => WPWHPRO()->helpers->translate( 'a membership expired', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a membership expired within WooCommerce Memberships.', $translation_ident ),
