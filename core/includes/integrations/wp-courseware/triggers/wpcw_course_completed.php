...
if ( ! class_exists( 'WP_Webhooks_Integrations_wp_courseware_Triggers_wpcw_course_completed' ) ) :

 /**
  * Load the wpcw_course_completed trigger
  *
  * @since 4.3.5
  * @author Ironikus <info@ironikus.com>
  */
  class WP_Webhooks_Integrations_wp_courseware_Triggers_wpcw_course_completed {
	...
	public function get_callbacks(){
		...
		return array(
			array(
				'type' => 'action',
				'hook' => 'wpcw_user_completed_course',
				'callback' => array( $this, 'wpcw_course_completed_callback' ),
				'priority' => 20,
				'arguments' => 3,
				'delayed' => true,
			),
	...
	public function get_details(){
		...
		$translation_ident = "action-wpcw_course_completed-description";
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			...
			'webhook_slug' => 'wpcw_course_completed',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'wpcw_user_completed_course',
		...
		return array(
			'trigger'		   => 'wpcw_course_completed',
			'name'			  => WPWHPRO()->helpers->translate( 'Course completed', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a user completed a course', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a user completed a course within WP Courseware.', $translation_ident ),
	...
	public function wpcw_course_completed_callback( $user_id, $unit_id, $unit_parent_data ){

		$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'wpcw_course_completed' );
		...
		do_action( 'wpwhpro/webhooks/trigger_wpcw_course_completed', $payload, $response_data_array );
	}
