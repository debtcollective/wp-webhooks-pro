<?php
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Triggers_create_comment' ) ) :

	/**
	 * Load the create_comment trigger
	 *
	 * @since 4.1.0
	 * @author Ironikus <info@ironikus.com>
	 */
	class WP_Webhooks_Integrations_wordpress_Triggers_create_comment {
		...
		public function get_callbacks(){
            ...
            return array(
                array(
                    ...
                    'callback' => array( $this, 'ironikus_trigger_create_comment' ),
                    'priority' => 10,
                    'arguments' => 2,
                    'delayed' => true,
                ),
        ...
        public function get_details(){
            ...
            $translation_ident = "trigger-create_comment-description";

			$parameter = array(
				'comment_id'   => array( 'short_description' => WPWHPRO()->helpers->translate( 'The comment id of the currently created comment.', $translation_ident ) ),
				'comment_data'   => array( 'short_description' => WPWHPRO()->helpers->translate( 'The full data object of the comment.', $translation_ident ) ),
				'current_post_id'   => array( 'short_description' => WPWHPRO()->helpers->translate( 'The post id of the post the comment was created on.', $translation_ident ) ),
			...
			$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
				'webhook_name' => 'New Comment',
				'webhook_slug' => 'create_comment',
				'post_delay' => true,
				'trigger_hooks' => array(
					array( 
						'hook' => 'wp_insert_comment',
						'url' => 'https://developer.wordpress.org/reference/hooks/wp_insert_comment/',
					),
				)
			) );
            ...
            return array(
                ...
                'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires after a new comment was created.', $translation_ident ),
