<?php
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Triggers_trash_comment' ) ) :

	/**
	 * Load the trash_comment trigger
	 *
	 * @since 4.1.0
	 * @author Ironikus <info@ironikus.com>
	 */
	class WP_Webhooks_Integrations_wordpress_Triggers_trash_comment {
		...
		public function get_callbacks(){
            ...
            return array(
                array(
                    ...
                    'callback' => array( $this, 'ironikus_trigger_trash_comment' ),
                    'priority' => 10,
                    'arguments' => 2,
                    'delayed' => true,
                ),
        ...
        public function get_details(){
            ...
            $translation_ident = "trigger-trash_comment-description";

			$parameter = array(
				'comment_id'   => array( 'short_description' => WPWHPRO()->helpers->translate( 'The comment id of the currently trashed comment.', $translation_ident ) ),
				'comment_data'   => array( 'short_description' => WPWHPRO()->helpers->translate( 'The full data object of the comment.', $translation_ident ) ),
				'current_post_id'   => array( 'short_description' => WPWHPRO()->helpers->translate( 'The post id of the post the comment was trashd on.', $translation_ident ) ),
            ...
            return array(
                ...
                'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires after a comment was trashed.', $translation_ident ),
        ...
        public function ironikus_trigger_trash_comment( $comment_id, $comment ){
			...
			do_action( 'wpwhpro/webhooks/trigger_trash_comment', $comment_id, $comment, $data_array, $response_data );
