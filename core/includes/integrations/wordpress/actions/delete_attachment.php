		...
		public function execute( $return_data, $response_body ){
			...
			if( ! empty( $attachment_id ) ){
				...
				if( ! empty( $check ) ){
					...
					$return_args['msg'] = WPWHPRO()->helpers->translate( "Attachment successfully deleted.", 'action-delete_attachment-success' );

				} else {

					$return_args['data']['post_data'] = $check;
					$return_args['msg'] = WPWHPRO()->helpers->translate( "Error while deleting the attachment.", 'action-delete_attachment-success' );
				...
				$return_args['msg'] = WPWHPRO()->helpers->translate( "No attachment id set.", 'action-delete_attachment-success' );
