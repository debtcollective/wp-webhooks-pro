	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			if( ! empty( $source_path ) && ! empty( $destination_path ) ){
				...
				if( $check ){
					$return_args['msg'] = WPWHPRO()->helpers->translate("The file was successfully copied.", 'action-copy_file-success' );
					$return_args['success'] = true;
				} else {
					$return_args['msg'] = WPWHPRO()->helpers->translate("File was not copied because of an error.", 'action-copy_file-failure' );
				}
			}
