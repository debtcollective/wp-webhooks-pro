	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			if( ! empty( $source_path ) && ! empty( $destination_path ) ){
				...
				if( $check ){
					$return_args['msg'] = WPWHPRO()->helpers->translate("The file/folder was successfully renamed.", 'action-rename_file_folder-success' );
					$return_args['success'] = true;
				} else {
					$return_args['msg'] = WPWHPRO()->helpers->translate("File/folder was not renamed because of an error.", 'action-rename_file_folder-failure' );
				}
			}
