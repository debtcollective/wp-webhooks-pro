...
<?php
		...
		public function execute( $return_data, $response_body ){
			...
			if( empty( $plugin_slug ) ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "Please set the plugin_slug to continue.", 'action-plugin_deactivate-failure' );
				return $return_args;
			}

			$check = $plugin_helpers->deactivate( $plugin_slug );
			if( $check ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "Plugin successfully deactivated.", 'action-plugin_deactivate-success' );
				$return_args['success'] = true;
			} else {
				$return_args['msg'] = WPWHPRO()->helpers->translate( "The plugin was not deactivated.", 'action-plugin_deactivate-success' );
			}
