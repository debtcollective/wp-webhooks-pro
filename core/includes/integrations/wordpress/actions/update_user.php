...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Actions_update_user' ) ) :
	...
	public function get_details(){
		...
		$parameter = array(
			'user_id'		   => array( 'short_description' => WPWHPRO()->helpers->translate( '(Optional if user_email or user_login is defined) Include the numeric id of the user. (Note that the user_id has a higher priority than the user_email.)', $translation_ident ) ),
			'user_email'		=> array( 'short_description' => WPWHPRO()->helpers->translate( '(Optional if user_id or user_login is defined) Include the email correlated to the account.', $translation_ident ) ),
			'user_login'		=> array(
			...
			'acf_meta_update' => array( 
				...
				'short_description' => WPWHPRO()->helpers->translate( 'Update (or add) Advanced Custom Fields meta keys/values.', $translation_ident ),
			),
			'manage_acf_data' => array( 
				'label' => WPWHPRO()->helpers->translate( 'Manage ACF Data (Advanced)', $translation_ident ),
				'short_description' => WPWHPRO()->helpers->translate( 'In case you want to add more complex Advanced Custom Fields data, this field is for you. Check out some examples within our post meta blog post.', $translation_ident )
			),
			'send_email'		=> array(
