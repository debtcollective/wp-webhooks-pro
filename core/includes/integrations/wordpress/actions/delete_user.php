...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Actions_delete_user' ) ) :
	...
	public function get_details(){
		...
		$parameter = array(
			'user_id'	   => array( 'short_description' => WPWHPRO()->helpers->translate( '(Optional if user_email is defined) Include the numeric id of the user.', $translation_ident ) ),
			'user_email'	=> array( 'short_description' => WPWHPRO()->helpers->translate( '(Optional if user_email is defined) Include the assigned email of the user.', $translation_ident ) ),
			'send_email'	=> array(
