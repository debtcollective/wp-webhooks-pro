	...
	public function get_details(){
		...
		$returns = array(
			...
			$description = WPWHPRO()->webhook->get_endpoint_description( 'action', array(
				...
				'tipps' => array(
					sprintf( WPWHPRO()->helpers->translate( "This webhook makes sense if you want to test if %s works properly on your WordPress website. You can try to setup different values to see how the webhook interacts with your site.", $translation_ident ), WPWHPRO()->settings->get_page_title() )
				),
			) );
