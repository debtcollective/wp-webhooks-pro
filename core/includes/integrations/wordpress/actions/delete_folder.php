	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			if( ! empty( $folder ) ){
				...
				if( $check ){
					$return_args['msg'] = WPWHPRO()->helpers->translate("Folder and sub folder/files successfully deleted.", 'action-create_folder-success' );
					$return_args['success'] = true;
				} else {
					$return_args['msg'] = WPWHPRO()->helpers->translate("Folder was not deleted because of an error.", 'action-create_folder-failure' );
				}
			}
