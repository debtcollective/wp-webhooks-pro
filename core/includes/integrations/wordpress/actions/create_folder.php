	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			if( ! empty( $folder ) ){
				...
				if( $check ){
					$return_args['msg'] = WPWHPRO()->helpers->translate("Folder successfully created.", 'action-create_folder-success' );
					$return_args['success'] = true;
				} else {
					$return_args['msg'] = WPWHPRO()->helpers->translate("Folder was not created because of an error.", 'action-create_folder-failure' );
				}
			}
