...
if ( ! class_exists( 'WP_Webhooks_Integrations_wordpress_Actions_wp_manage_post_meta_data' ) ) :
	...
	public function get_details(){
		...
		$translation_ident = "action-wp_manage_post_meta_data-description";

		$parameter = array(
			'post_id' => array( 'required' => true, 'short_description' => WPWHPRO()->helpers->translate( 'The ID of the post you want to perform the action for.', $translation_ident ) ),
			'meta_update' => array( 
				'type' => 'repeater',
...
<pre>
{
	"meta_key": "Meta Value"
		...
		ob_start();
		?>
<?php echo WPWHPRO()->helpers->translate( "This argument integrates the full features of managing post related meta values (Advanced).", $translation_ident ); ?>
<br>
<p class="text-secondary">
  <strong><?php echo WPWHPRO()->helpers->translate( "Important:", $translation_ident ); ?></strong> <?php echo WPWHPRO()->helpers->translate( "We created a meta value generator that helps you to get started using this argument. You will find the generator here within the ACF section:", $translation_ident ); ?> <a target="_blank" title="<?php echo WPWHPRO()->helpers->translate( "Advanced Custom Fields Meta value generator", $translation_ident ); ?>" href="https://wp-webhooks.com/blog/how-to-update-custom-post-meta-values-with-wp-webhooks/">https://wp-webhooks.com/blog/how-to-update-custom-post-meta-values-with-wp-webhooks/</a>.
</p>
<br>
<br>
...
<ol>
	...
	<li><?php echo WPWHPRO()->helpers->translate( "The webhook response contains a validted array that shows each initialized meta entry, as well as the response from its original WordPress function. This way you can see if the meta value was adjusted accordingly.", $translation_ident ); ?></li>
		...
		$parameter['manage_meta_data']['description'] = ob_get_clean();
			...
			ob_start();
		?>
<?php echo WPWHPRO()->helpers->translate( "The do_action argument is an advanced webhook for developers. It allows you to fire a custom WordPress hook after the wp_manage_post_meta_data action was fired.", $translation_ident ); ?>
<br>
...
<ol>
	...
	<li>
		...
		<?php echo WPWHPRO()->helpers->translate( "An array containing further information about the simplified meta that should be added/updated.", $translation_ident ); ?>
	</li>
</ol>
		<?php
		$parameter['do_action']['description'] = ob_get_clean();
			...
			$description = WPWHPRO()->webhook->get_endpoint_description( 'action', array(
				'webhook_name' => 'Manage WP post meta',
				'webhook_slug' => 'wp_manage_post_meta_data',
				'steps' => array(
					WPWHPRO()->helpers->translate( "Please also set the <strong>post_id</strong> argument. Set it to the ID of your chosen post.", $translation_ident ),
			...
			return array(
				...
				'name'			  => WPWHPRO()->helpers->translate( 'Manage WP post meta', $translation_ident ),
				'sentence'			  => WPWHPRO()->helpers->translate( 'add, update, or delete WP post meta', $translation_ident ),
				'parameter'		 => $parameter,
				'returns'		   => $returns,
				'returns_code'	  => $returns_code,
				'short_description' => WPWHPRO()->helpers->translate( 'Add, update, or delete custom post meta data within "WordPress".', $translation_ident ),
		...
		public function execute( $return_data, $response_body ){
			...
			$translation_ident = "action-wp_manage_post_meta_data-execute";
			$return_args = array(
				'success' => false,
				'msg' => '',
				'data' => array(),
			...
			if( empty( $post ) ){
				$return_args['msg'] = WPWHPRO()->helpers->translate( "The post you try to update does not exist.", $translation_ident );
				return $return_args;
			}
