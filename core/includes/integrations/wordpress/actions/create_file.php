	...
	<li>
		...
		public function execute( $return_data, $response_body ){
			...
			if( ! empty( $content ) && ! empty( $file ) ){
				...
				if( $check ){
					$return_args['msg'] = WPWHPRO()->helpers->translate("File successfully created.", 'action-create-file-success' );
					$return_args['success'] = true;
				} else {
					$return_args['msg'] = WPWHPRO()->helpers->translate("File was not created because of an error or because it already exists", 'action-create-file-failure' );
				}
			}
