<?php
if ( ! class_exists( 'WP_Webhooks_Integrations_advanced_custom_fields_Actions_acf_manage_post_meta_data' ) ) :

	/**
	 * Load the acf_manage_post_meta_data action
	 *
	 * @since 4.3.7
	 * @author Ironikus <info@ironikus.com>
	 */
	class WP_Webhooks_Integrations_advanced_custom_fields_Actions_acf_manage_post_meta_data {

	public function get_details(){

		$translation_ident = "action-acf_manage_post_meta_data-description";
...
<pre>
{
	"meta_key": "Meta Value"
		...
		$parameter['manage_acf_data']['description'] = ob_get_clean();
			...
			ob_start();
		?>
<?php echo WPWHPRO()->helpers->translate( "The do_action argument is an advanced webhook for developers. It allows you to fire a custom WordPress hook after the acf_manage_post_meta_data action was fired.", $translation_ident ); ?>
<br>
	...
	<li>
		...
		$parameter['do_action']['description'] = ob_get_clean();
			...
			$description = WPWHPRO()->webhook->get_endpoint_description( 'action', array(
				'webhook_name' => 'Manage ACF post meta',
				'webhook_slug' => 'acf_manage_post_meta_data',
				'steps' => array(
			...
			return array(
				'action'			=> 'acf_manage_post_meta_data',
				'name'			  => WPWHPRO()->helpers->translate( 'Manage ACF post meta', $translation_ident ),
				'sentence'			  => WPWHPRO()->helpers->translate( 'add, update, or delete ACF post meta', $translation_ident ),
				'parameter'		 => $parameter,
				'returns'		   => $returns,
				'returns_code'	  => $returns_code,
				'short_description' => WPWHPRO()->helpers->translate( 'Add, update, or delete custom post meta data within "Advanced Custom Fields".', $translation_ident ),
		...
		public function execute( $return_data, $response_body ){
			...
			$translation_ident = "action-acf_manage_post_meta_data-execute";
			$return_args = array(
				'success' => false,
				'msg' => '',
				'data' => array(),
			...
			$return_args = WPWHPRO()->acf->manage_acf_meta( $post_id, $manage_acf_data );
