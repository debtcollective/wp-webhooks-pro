...
if ( ! class_exists( 'WP_Webhooks_Integrations_groundhogg_Triggers_ghogg_contact_tag_added' ) ) :

 /**
  * Load the ghogg_contact_tag_added trigger
  *
  * @since 4.3.5
  * @author Ironikus <info@ironikus.com>
  */
  class WP_Webhooks_Integrations_groundhogg_Triggers_ghogg_contact_tag_added {
	...
	public function get_callbacks(){
		...
		return array(
			array(
				...
				'callback' => array( $this, 'ghogg_contact_tag_added_callback' ),
				'priority' => 20,
				'arguments' => 2,
				'delayed' => true,
			),
	...
	public function get_details(){
		...
		$translation_ident = "action-ghogg_contact_tag_added-description";

		$parameter = array(
			'tag_id' => array( 'short_description' => WPWHPRO()->helpers->translate( '(Integer) The id of the tag that was added.', $translation_ident ) ),
		...
		$description = WPWHPRO()->webhook->get_endpoint_description( 'trigger', array(
			'webhook_name' => 'Contact tag added',
			'webhook_slug' => 'ghogg_contact_tag_added',
			'post_delay' => true,
			'trigger_hooks' => array(
				array( 
					'hook' => 'groundhogg/contact/tag_applied',
		...
		return array(
			'trigger'		   => 'ghogg_contact_tag_added',
			'name'			  => WPWHPRO()->helpers->translate( 'Contact tag added', $translation_ident ),
			'sentence'			  => WPWHPRO()->helpers->translate( 'a tag was added to a contact', $translation_ident ),
			'parameter'		 => $parameter,
			'settings'		  => $settings,
			'returns_code'	  => $this->get_demo( array() ),
			'short_description' => WPWHPRO()->helpers->translate( 'This webhook fires as soon as a tag was added to a contact within Groundhogg.', $translation_ident ),
	...
	public function ghogg_contact_tag_added_callback( $contact, $tag_id ){

		$webhooks = WPWHPRO()->webhook->get_hooks( 'trigger', 'ghogg_contact_tag_added' );
		...
		do_action( 'wpwhpro/webhooks/trigger_ghogg_contact_tag_added', $payload, $response_data_array );
	}
